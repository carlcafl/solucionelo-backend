...
create table tblUsers(id serial NOT NULL primary key, registeredDate timestamp NOT NULL default now(), ipAddress varchar(50) NOT NULL, idType varchar(2) NOT NULL, idNumber varchar(20) NOT NULL, firstName varchar(50) NOT NULL, lastName varchar(50) NOT NULL, phone varchar(10), mobile varchar(10), email varchar(100), city varchar(200));
